...
- **[SvelteKit 5](https://svelte.dev/)** — reactive UI with TypeScript
...
Early development. The three-mode workspace (editor, chat, terminal) and AI integrations are actively being built on top of the Tauri + SvelteKit foundation.
