...
pub fn git_stage(
    ...
    run_coordinated(
        ...
        "stage",
        |ctx, coord| {
            let result = mutations::stage_with(
...
pub fn git_discard(
    ...
    run_coordinated(
        ...
        "discard",
        |ctx, coord| {
            let result = mutations::discard_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_commit(
    ...
    run_coordinated(
        ...
        "commit",
        |ctx, coord| {
            let result = mutations::commit_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_stash(
    ...
    run_coordinated(
        ...
        "stash",
        |ctx, coord| {
            let result = mutations::stash_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_fetch(
    ...
    run_coordinated(
        ...
        "fetch",
        |ctx, coord| {
            let result = remote::git_fetch_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_pull(
    ...
    run_coordinated(
        ...
        "pull",
        |ctx, coord| {
            let result = remote::git_pull_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_push(
    ...
    run_coordinated(
        ...
        "push",
        |ctx, coord| {
            let result = remote::git_push_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_mutate_ref(
    ...
    run_coordinated(
        ...
        "mutate-ref",
        |ctx, coord| {
            let result = refs::mutate_ref_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_submodule(
    ...
    if matches!(
        input.action,
        submodule::SourceControlSubmoduleAction::Status
    ) {
...
pub fn git_lfs(
    ...
    run_coordinated(
        ...
        "lfs",
        |ctx, coord| {
            let result = lfs::lfs_action_with(
                &process::SystemGitProcess,
                input,
                &scope,
                Some((ctx, coord)),
...
pub fn git_worktree_attach(
    ...
    run_coordinated_identity(
        ...
        move |_ctx, _coord| {
            let result =
                worktree::attach_worktree_with(&process::SystemGitProcess, input, &registry)?;
