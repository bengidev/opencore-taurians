...
**Bottom Panel**:
The bordered strip at the bottom of the **center column** — settings entry and reserved status area.
_Avoid_: Footer bar, status dock

**Main Card Tabs**:
The tab row at the top of the center column with main-card switches (chat / terminal / editor). Closed side-panel toggles appear at the leading/trailing edges of this row.
